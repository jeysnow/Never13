...
namespace GooglePlayGames
{
    ...
    public class PlayGamesPlatform : ISocialPlatform
    {
        ...
        {
            Debug.Log("myTest:"+"Calling InitializeNearby!");
            if (sNearbyConnectionClient == null)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                NearbyConnectionClientFactory.Create(client => {
                    Debug.Log("myTest:"+"Nearby Client Created!!");
                    sNearbyConnectionClient = client;
                    if (callback != null) {
                        callback.Invoke(client);
                    }
                    else {
                        Debug.Log("myTest:"+"Initialize Nearby callback is null");
                    }
                });
#else
            ...
            {
                Debug.Log("myTest:"+"Nearby Already initialized: calling callback directly");
                callback.Invoke(sNearbyConnectionClient);
            }
            else
            {
                Debug.Log("myTest:"+"Nearby Already initialized");
            }
        }
